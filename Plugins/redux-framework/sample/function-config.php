<?php
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Curabitur', 'redux-framework-demo' ),
        'id'         => 'design-curabitur',
        'subsection' => true,
        'fields'     => array(
            array(
...
array(
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Sem', 'redux-framework-demo' ),
        'id'         => 'opt-Sem',
        'subsection' => true,
        'fields'     => array(
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Faucibus', 'redux-framework-demo' ),
        'id'         => 'opt-faucibus',
        'subsection' => true,
        'fields'     => array(
   ...
   //footer section start
    ...
    Redux::setSection( $opt_name, array(
        'title' => __( 'widget', 'redux-framework-demo' ),
        'id'    => 'text',
        'desc'  => __( '', 'redux-framework-demo' ),
        'icon'  => 'el el-picture'
    ) );
 ...
 Redux::setSection( $opt_name, array(
        'title'      => __( 'Widget3', 'redux-framework-demo' ),
        'id'         => 'opt-widget3',
        'subsection' => true,
        'fields'     => array(
